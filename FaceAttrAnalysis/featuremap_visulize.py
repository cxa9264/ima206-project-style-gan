...
if __name__ == '__main__':
    # the test image path
    image_path = "/home/litianyu/ima206-project-style-gan/interfacegan/data/stylegan_celebahq/000000.jpg"
    ...
    state_dict = torch.load("./result/Resnet18.pth", map_location='cuda:0')
